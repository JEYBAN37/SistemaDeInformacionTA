  ...
  <header class="main-header">
    ...
    <a href="<?php echo $this->Url->build('/'); ?>" class="logo">
      ...
      <!-- logo for regular state and mobile devices -->
       <!--?php echo $this->Html->image('SICB-logo.png', array('class' => 'img-circle', 'alt' => 'User Image')); ?-->

      <span class="logo-lg"><div class="pull-left">
                    <?php echo $this->Html->image('SICB-logo.png', array('class' => 'img-circle', 'width' => '100px', 'height' => '65px')); ?></span>
                  </div>

    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <?php echo $this->element('nav-top_login'); ?>
  </header>

  <?php echo $this->element('aside-main-sidebar_login'); ?>
