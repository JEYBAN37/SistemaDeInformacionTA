...
class ProductosController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Responsables', 'Referentes'],
        ];
    ...
    public function add()
    {
        ...
        $responsables = $this->Productos->Responsables->find('list', ['limit' => 200]);
        $referentes = $this->Productos->Referentes->find('list', ['limit' => 200]);
        $this->set(compact('producto', 'responsables', 'referentes'));
    }
