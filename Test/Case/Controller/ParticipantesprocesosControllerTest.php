<?php
App::uses('ParticipantesprocesosController', 'Controller');

/**
 * ParticipantesprocesosController Test Case
 *
 */
class ParticipantesprocesosControllerTest extends ControllerTestCase {
