<?php
App::uses('SisProcesosViewTestsController', 'Controller');

/**
 * SisProcesosViewTestsController Test Case
 *
 */
class SisProcesosViewTestsControllerTest extends ControllerTestCase {
