            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-10">
                    <div class="wrap d-md-flex">
                        <div class="img"
                            style="background-image: url(https://ieu.unal.edu.co/images/03_20_2023_Nota_Ana_maria.jpg);">
                        </div>
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <div class="input-group custom-search-form ">
                        ...
                        <input name="data[User][codigo]" style="border-radius: 6px;" id="codigo" required="required"
                            onkeypress="mayus(this);" type="text" class="form-control" name="UserUsername" required=""
                            autofocus="" placeholder="Codigo verificación"><br>
