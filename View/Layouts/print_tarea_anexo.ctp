...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Soportes-Ciudad Bienestar </title>
    ...
    <body>            
        ...
        <table>
            <tr>
                <td </br><a href="../nuebus" ><img src="../../img/home-icon.png" width="20" height="20" > Productosactividades</a>  <a href="javascript:window.print();" target="_blank"><img src="../../img/print.png" width="20" height="20" > Imprimir</a>
                <a class="copi" href="javascript:getlink();">Copiar URL</a></td></td> </tr>
                </table>
         
       

      <strong><img src="../../img/actividad_ps_encabezado.jpg" style ="width: 93%;"></strong></br> 
        ...
        <!--/br><strong><img src="../../img/acta_ps_pie.jpg" style ="width: 95%;"></strong></br-->
