...
<div>
    ...
    <div class="panel-heading">
        ...
        <div>
            <button type="button" class="btn btn-default dropdown-toggle, alert alert-success">

                <?php echo $this->Html->link(__('Editar datos de enlaces'), array('action' => 'edit', $canalizacion['Canalizacion']['id'])); ?>
            </button>
