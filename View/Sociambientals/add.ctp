...
<fieldset>
    ...
    <div class="col-md-4" >
        <?php
            ...
            echo $this->Form->input('riesgoexterno', array(
                'label' => 'Identifique en el entorno hay',
                'class' => 'form-control',
                'type' => 'select',
                'options' => $option,
                'class' => 'form-control select-search'
    ...
    <div class="col-md-4">
        <?php
            ...
            echo $this->Form->input('otroriesgo', array(
                'label' => 'Otro riesgo interno o externo',
                'class' => 'form-control'
            ));
        ?>
    </div>
    <div class="col-md-4">
        <?php
            ...
            echo $this->Form->input('actividad', array(
    ...
    <div class="col-md-4">
        <?php
            ...
            echo $this->Form->input('acceso', array(
                'label' => 'En su sector es dificil acceder fácilmente a:',
                'class' => 'form-control',
                'type' => 'select',
                'options' => $option,
                'class' => 'form-control select-search'
    ...
    <div class="col-md-4">
        <?php
            ...
            echo $this->Form->input('transporte', array(
                'label' => 'Medio de transporte predominante',
                'class' => 'form-control',
                'type' => 'select',
                'options' => $option,
                'class' => 'form-control select-search'
    ...
    <div class="col-md-4">
        <?php
            $option = array('' => 'Elegir', 'Objetos cortantes' => 'Objetos cortantes', 'Sustancias quimicas_aseo a la vista' => 'Sustancias quimicas_aseo a la vista', 'Medicamentos a la vista' => 'Medicamentos a la vista', 'Uso de Velas' => 'Uso de Velas', 'Conexiones Electricas inadecuadas' => 'Conexiones Electricas inadecuadas', 'Ninguno' => 'Ninguno');
            echo $this->Form->input('riesgo', array(
                'label' => 'Se identifican algunos riesgo de accidente en la vivienda',
                'class' => 'form-control',
                'type' => 'select',
                'options' => $option,
                'class' => 'form-control select-search'
    ...
    <div class="col-md-4">
        <?php
            echo $this->Form->input('otroriesgohogar', array(
                'label' => 'Otro riesgo adicional',
                'class' => 'form-control',
                'class' => 'form-control select-search'
            ));
        ?>
    ...
    <div class="col-md-4">
        <?php
            $option = array('' => 'Elegir', 'Empopasto' => 'Empopasto', 'Acueducto Comunitario' => 'Acueducto Comunitario', 'Agua envasada' => 'Agua envasada');
            echo $this->Form->input('aguaservicio', array(
                'label' => 'Principal fuente de abastecimiento de agua para consumo',
                'class' => 'form-control',
                'type' => 'select',
                'options' => $option,
                'class' => 'form-control select-search'
    ...
    <div class="col-md-4">
        <?php
            $option = array('' => 'Elegir', 'Directamente del grifo' => 'Directamente del grifo', 'Hierve' => 'Hierve', 'Filtra' => 'Filtra', 'Ozonifica' => 'Ozonifica', 'Desinfección con cloro' => 'Desinfección con cloro');
            echo $this->Form->input('aguatratamiento', array(
                'label' => 'Realiza algun tratamiento al agua para el consumo',
                'class' => 'form-control',
                'type' => 'select',
                'options' => $option,
                'class' => 'form-control select-search'
    ...
    <div class="col-md-4">
        <?php
            $option = array('' => 'Elegir', 'Permanente' => 'Permanente', 'Intermitente' => 'Interminente', 'Razonamientos prolongados' => 'Razonamientos prolongados');
            echo $this->Form->input('aguasiministro', array(
                'label' => '¿Cuenta con suministro de agua?',
                'class' => 'form-control',
                'type' => 'select',
                'options' => $option,
                'class' => 'form-control select-search'
    ...
    <div class="col-md-4">
        <?php
            ...
            echo $this->Form->input('aguaalmacenamiento', array(
    ...
    <div class="col-md-4">
        <?php
            ...
            echo $this->Form->input('diposicionexcretas', array(
    ...
    <div class="col-md-4">
        <?php
            $option = array('' => 'Elegir', 'Conexión al alcantarillado' => 'Conexión alcantarillado', 'Campo abierto ' => 'Campo Abierto');
            echo $this->Form->input('aguaresiduales', array(
    ...
    <div class="col-md-4">
        <?php
            ...
            echo $this->Form->input('basura', array(
    ...
    <div class="col-md-4">
        <?php
            ...
            echo $this->Form->input('reciclaje', array(
...
<!-- Conditions-------------------------------------------------------------------->
    ...
    <div class="grow justify-content-center  "style=" margin-top: -10px;font-size: 12px;" >
            ...
            <?php echo $this->Form->end(__('Validar'), ['class' => 'form-control btn btn-primary']);
            ?>
