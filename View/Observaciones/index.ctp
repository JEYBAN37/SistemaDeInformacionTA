...
<div class="col-12 text-center " style="margin: 20px; margin-top: 40px;">
	<h1 class="titulo-general-pwa-govco" style="color: #3366CC;margin-top: 25px;font-size: 3.5rem ;font-family: 'MiFuenteBold','Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">Listado de Observaciones
	</h1>
</div>
							...
							<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
								<thead>
									<tr>
										...
										<th>Riesgo de vivienda</th>
										<th>Riesgo Primera Infancia</th>
										<th>Riesgo Enfermedad cronica</th>
								...
								<tbody>
									<?php foreach ($gestantes as $gestante) : ?>
										<tr class="gradeA odd">
											<td class="sorting_1"><?php echo ($observacion['Observacion']['id']); ?>&nbsp;</td>
											<td>
												<?php echo $this->Html->link($observacion['Observacion']['familia_id'], array('controller' => 'familias', 'action' => 'view', $gestante['Familia']['id'])); ?>
											</td>
											<td><?php echo ($observacion['Observacion']['riesgovivienda']); ?>&nbsp;</td>
											<td><?php echo ($observacion['Observacion']['riesgoprimerainfancia']); ?>&nbsp;</td>
											<td><?php echo ($observacion['Observacion']['riesgoenfermedadcronica']); ?>&nbsp;</td>
											<td><?php echo ($observacion['Observacion']['riesgogestante']); ?>&nbsp;</td>
											<td><?php echo ($observacion['Observacion']['riesgosicosocial']); ?>&nbsp;</td>
											<td><?php echo ($observacion['Observacion']['riesgofamilia']); ?>&nbsp;</td>
											<td><?php echo ($observacion['Observacion']['date']); ?>&nbsp;</td>
											<td><?php echo ($observacion['Observacion']['observacion']); ?>&nbsp;</td>
											<td><?php echo ($observacion['Observacion']['dir']); ?>&nbsp;</td>
											<td><?php echo ($observacion['Observacion']['anexo']); ?>&nbsp;</td>
											<td class="actions">
												<div class="btn-group">
