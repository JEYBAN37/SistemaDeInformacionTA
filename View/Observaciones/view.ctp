												...
												<div class="col-sm-11">
													...
													<table width="100%" class="table table-striped table-bordered table-hover">
														...
														<tr>
															...
															<td colspan="3"><?php echo ($observacion['Observacion']['riesgogestante']); ?></td>
															<td colspan="3">Riesgo Primera Infancia</td>
															<td colspan="3"><?php echo ($observacion['Observacion']['riesgoprimerainfancia']); ?></td>

														</tr>

														<tr>
															<td colspan="3">Riesgo De Enfermedades Cronicas</td>
															<td colspan="3"><?php echo ($observacion['Observacion']['riesgoenfermedadcronica']); ?></td>
															<td colspan="3">Riesgo Enfermedades Cronicas</td>
															<td colspan="3"><?php echo ($observacion['Observacion']['riesgosicosocial']); ?></td>

														</tr>

														<tr>
															<td colspan="3">Riesgo en la Familia</td>
															<td colspan="3"> <?php echo ($observacion['Observacion']['riesgofamilia']); ?></td>
															<td colspan="3">Riesgo en la Vivienda</td>
															<td colspan="3"><?php echo ($observacion['Observacion']['riesgovivienda']); ?></td>
														</tr>

														<tr>
															<td colspan="2">Observacion</td>
															<td colspan="12"><?php echo ($observacion['Observacion']['observacion']); ?></td>
														...
														<tr>
															...
															<td colspan="3"><?php echo ($observacion['Observacion']['dir']); ?></td>
															<td colspan="3">Anexo</td>
															<td colspan="3"><?php echo ($observacion['Observacion']['anexo']); ?></td>
														</tr>

														<tr>
															<td colspan="2">Fecha de Registro</td>
															<td colspan="10"><?php echo ($observacion['Observacion']['observacion']); ?></td>
														</tr>
													</table>
												</div>
											</div>
