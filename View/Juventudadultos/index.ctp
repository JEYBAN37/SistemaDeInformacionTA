...
<div class="col-12 text-center " style="margin: 20px; margin-top: 40px;">
	<h1 class="titulo-general-pwa-govco" style="color: #3366CC;margin-top: 25px;font-size: 3.5rem ;font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">Listado de Juvenud Adultos
	</h1>
</div>
							...
							<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
								...
								<tbody>
									<?php foreach ($juventudadultos as $juventudadulto) : ?>
										<tr class="gradeA odd">
											<td class="sorting_1"><?php echo ($juventudadulto['Juventudadulto']['id']); ?>&nbsp;</td>
											<td>
											...
											<td><?php echo ($juventudadulto['Juventudadulto']['discapacidad']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['peso']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['talla']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['indicemasacorporal']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['tensionarterial']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['condicioncronica']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['condicioncronica1']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['ancededenteginecologico']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['esquemavacunacion']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['desparasitacion']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['valoracionmedica']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['valoracionrias']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['valoracionrias1']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['tomacitologia']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['saludoral']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['higieneoral']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['iniciovidasexual']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['metodosanticonceptivos']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['infeccionestransmisionsexual']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['consumospa']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['consumospa1']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['riesgopsicosocial']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['riesgopsicosocial1']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['estudio']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['rendimientoescolar']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['sopechamaltrato']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['canalizacionuno']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['canalizaciondos']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['eduacionuno']); ?>&nbsp;</td>
											<td><?php echo ($juventudadulto['Juventudadulto']['educaciondos']); ?>&nbsp;</td>
											<td class="actions">
												<div class="btn-group">
