    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar">
                ...
                <?php
                if ($auxDsr === false) {
                    echo '<li><a href="../actas/add">Nueva Acta</a></li>';
                } else {
                    //echo '<li><a href="../../../add">Nueva Acta</a></li>';
                }
                ?> 
                <li><a href="http://sistemasycomunicaciones.com.co/Manual/" target="_blank">Ayuda</a></li>
                <li>
                    <?php
                    if ($auxDsr === false) {
