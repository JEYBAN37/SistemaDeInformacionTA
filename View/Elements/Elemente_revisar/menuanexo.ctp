    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <li><?php echo $this->Html->link(__('Ingreso soporte'), array('action' => 'add')); ?></li>
            ...
            <li> <a href="http://www.sistemasycomunicaciones.com.co/sistemainformacioncb/app/webroot/files/Dimensiones_productos%20anexo_2017.xlsx" target="_blank"><A HREF=""></A></a></li>
