...
<div class="dimensiones index">
	<h2><?php echo __('Dimensiones'); ?></h2>
	<table cellpadding="0" cellspacing="0">
	<tr>
			<th><?php echo $this->Paginator->sort('id'); ?></th>
			<th><?php echo $this->Paginator->sort('nombre_dimension'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($dimension['Dimension']['nombre_dimension']); ?>&nbsp;</td>
		<td><?php echo h($dimension['Dimension']['definicion']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $dimension['Dimension']['id']), array(), __('Are you sure you want to delete # %s?', $dimension['Dimension']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
