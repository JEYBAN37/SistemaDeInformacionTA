...
<h3><a><img src="../../img/escudosms.png" width="40" height="auto"></a> Plan de Salud Publica de Intervenciones Colectivas </h3>
								...
								<tbody>
									...
									<?php foreach ($familias as $familia) : ?>
										<tr class="gradeA odd">
											...
											<td><?php echo $this->Html->link($familia['Sociambiental']['responsable_id'], array('controller' => 'sociambientals', 'action' => 'view', $familia['Sociambiental']['id'])); ?></td>
											<td><?php echo $this->Html->link($familia['Sociambiental']['id'], array('controller' => 'sociambientals', 'action' => 'view', $familia['Sociambiental']['id'])); ?></td>
											...
											<td><?php echo $this->Time->format('d-m-Y h:i A', ($familia['Sociambiental']['fecha'])); ?></td>
											...
											<td class="actions">
												<div class="btn-group">
													...
													<ul class="dropdown-menu" role="menu">
														<li><?php echo $this->Html->link(('New Familia'), array('action' => 'add')); ?></li>
														...
														<li><?php echo $this->Html->link(('List Discapacidades'), array('controller' => 'discapacidades', 'action' => 'index')); ?> </li>
														<li><?php echo $this->Html->link(('New Discapacidad'), array('controller' => 'discapacidades', 'action' => 'add')); ?> </li>
														<li><?php echo $this->Html->link(('List Victimas'), array('controller' => 'victimas', 'action' => 'index')); ?> </li>
														<li><?php echo $this->Html->link(('New Victima'), array('controller' => 'victimas', 'action' => 'add')); ?> </li>
