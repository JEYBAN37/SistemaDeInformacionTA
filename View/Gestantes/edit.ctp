...
<?php echo $this->Form->create('Gestante'); ?>
	<fieldset>
		<legend><?php echo __('Edit Gestante'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Gestante.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Gestante.id'))); ?></li>
