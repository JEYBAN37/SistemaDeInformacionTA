...
<?php echo $this->Form->create('Infantil'); ?>
	<fieldset>
		...
		<div class="col-12 text-center">
			<h1 class="titulo-general-pwa-govco" style="color: #3366CC;margin-top: 20px; ">Modulo Infancia - 6 a 11 años
			</h1>
		</div>
...
'placeholder' => ''
	...
	<div class="form-group col-md-6">
		...
		$option = array(''=>'Elegir','neurológica'=>'neurológica','cardiovascular'=>'cardiovascular',
